...
function MovieDetails({
  ...
  // console.log("Greatest Ever!",isTop);
  ...
  //   [imdbRating]
  // );
  // if (imdbRating > 8) return "Greatest Ever!";
      ...
      {isLoading ? (
        ...
        <>
          <header>
            ...
            <img src={poster} alt={`The poster of ${movie}`} />
          ...
          {/* <p>The average rating {avgRating}</p> */}
          <section>
